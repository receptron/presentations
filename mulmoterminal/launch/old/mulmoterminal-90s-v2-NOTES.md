...
## グリッド密度の方針(2026-08-08 レビューより)

**基本は6セル、終盤(永続ビート)だけ9セル。** 回答ビートはセル単体のクローズアップにする —
ズームで寄った文脈の続きとして自然で、素材のグリッド密度(4セルテイク由来)が画面に出ないため
連続性が壊れない。6セルテイクで回答まで通しで撮り直せたらワイドに戻してよい。
