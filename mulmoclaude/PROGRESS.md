...
|---|---|---|---|---|
| tutorials/collection-creation-demo | コレクション作成デモ — 天気予報コレクション | eyebrow「コレクション作成デモ」+ 題「天気予報コレクション」 | コレクション作成デモ | ja: [会話だけで「天気予報アプリ」を作る — MulmoClaude コレクション作成デモ](https://youtu.be/VJMlTwRz6z4)（メタデータ: youtube/collection-creation-demo_ja.md） |
