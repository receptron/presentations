...
| tutorials/building-a-collection | T1 | 📝 未 commit | — | 未着手 | — | — |
...
1. 台所三点セットの作り方デッキ（tutorials/ に新規、`_ja` 先行で設計）
2. ja workspace で日本語ライブ作成・収録 → 翻訳データを en workspace（データの正）に反映して両 golden commit
3. en workspace で英語ライブ再演・収録
